...
![](4_big_sissabagama_lake_cost_dist.png) From here the `sf object` can be kept together or ripped apart to determine the distance or path a fish could swim within the system along with a whole host of other potential implications (e.g. interpolated paths).

Credit: [R. Lennox, PhD, Science Director - OTN](https://oceantrackingnetwork.org/staff/) for the original ideas around this script.
